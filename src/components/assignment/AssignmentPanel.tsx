  ...
  return (
    <div className="flex items-center gap-4 border-t border-gray-200 bg-gray-50 px-6 py-3">
      ...
      <button
        onClick={assign}
        disabled={isDisabled}
        className="ms-auto rounded-md bg-blue-600 px-5 py-1.5 text-sm font-medium text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-300 disabled:text-gray-500"
      >
        {t('assign')}
      </button>
    </div>
